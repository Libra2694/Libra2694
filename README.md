...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Menanti+fajar+di+batas+cakrawala.;Terang+akan+datang+setelah+gulita.;Code+is+poetry+written+in+logic.;Programs+must+be+written+for+people+to+read.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Dalam+baris+kode+terdapat+bait-bait+harapan." alt="Typing SVG" />
  </a>
