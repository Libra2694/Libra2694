...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+never+lies+comments+sometimes+do.;Code+is+poetry+written+in+logic.;Create+your+own+sunshine+on+cloudy+days.;Kebenaran+kode+berada+pada+baris+eksekusi.;Hustle+in+silence+let+success+make+the+noise.;Be+a+voice+not+an+echo.;Detail+kecil+menciptakan+kesempurnaan." alt="Typing SVG" />
  </a>
