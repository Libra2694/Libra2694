...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Be+a+voice+not+an+echo.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Talk+is+cheap.+Show+me+the+code.;Silence+is+the+canvas+of+deep+thoughts.;Setiap+langkah+adalah+bagian+dari+cerita." alt="Typing SVG" />
  </a>
