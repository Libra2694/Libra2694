...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Hustle+in+silence+let+success+make+the+noise.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Talk+is+cheap.+Show+me+the+code.;Lost+time+is+never+found+again.;The+best+way+to+predict+the+future+is+to+invent+it.;Code+is+poetry+written+in+logic.;Sebuah+kode+sejuta+cerita." alt="Typing SVG" />
  </a>
