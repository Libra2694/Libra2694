...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Rintangan+adalah+jembatan+menuju+kekuatan.;Dream+without+fear+code+without+limits.;Fokus+pada+proses+hasil+takkan+mengkhianati.;The+best+way+to+predict+the+future+is+to+invent+it.;Time+is+a+river+of+passing+events." alt="Typing SVG" />
  </a>
