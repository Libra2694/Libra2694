...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Silence+is+the+canvas+of+deep+thoughts.;Dream+without+fear+code+without+limits.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Mimpi+tanpa+aksi+hanyalah+ilusi.;Karya+terbaik+lahir+dari+ketekunan+tiada+henti.;Kebenaran+kode+berada+pada+baris+eksekusi.;What+we+think+we+become." alt="Typing SVG" />
  </a>
