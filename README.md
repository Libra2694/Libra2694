...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Time+is+a+river+of+passing+events.;The+best+way+to+predict+the+future+is+to+invent+it.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Menulis+kode+membelah+sunyinya+malam.;Setiap+langkah+adalah+bagian+dari+cerita.;Mulailah+dari+mana+kamu+berada+gunakan+apa+yang+kamu+punya.;Jangan+biarkan+hari+kemarin+menyita+hari+ini." alt="Typing SVG" />
  </a>
