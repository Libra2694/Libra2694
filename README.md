...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Rintangan+adalah+jembatan+menuju+kekuatan.;Karya+terbaik+lahir+dari+ketekunan+tiada+henti.;Code+never+lies+comments+sometimes+do.;Be+a+voice+not+an+echo.;The+best+way+to+predict+the+future+is+to+invent+it.;Code+is+poetry+written+in+logic.;Strive+not+to+be+a+success+but+rather+to+be+of+value." alt="Typing SVG" />
  </a>
