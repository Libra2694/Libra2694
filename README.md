...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Karya+terbaik+lahir+dari+ketekunan+tiada+henti.;Talk+is+cheap.+Show+me+the+code.;Create+your+own+sunshine+on+cloudy+days.;Sunyi+malam+adalah+teman+terbaik+sang+pemikir.;Menanti+fajar+di+batas+cakrawala." alt="Typing SVG" />
  </a>
