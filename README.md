...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;Dream+without+fear+code+without+limits.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Mimpi+tanpa+aksi+hanyalah+ilusi.;Jangan+biarkan+hari+kemarin+menyita+hari+ini.;Talk+is+cheap.+Show+me+the+code.;Programs+must+be+written+for+people+to+read." alt="Typing SVG" />
  </a>
