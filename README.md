...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+never+lies+comments+sometimes+do.;Sebuah+kode+sejuta+cerita.;Errors+are+proof+that+you+are+trying.;Terang+akan+datang+setelah+gulita.;Code+is+poetry+written+in+logic.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Menulis+kode+membelah+sunyinya+malam." alt="Typing SVG" />
  </a>
