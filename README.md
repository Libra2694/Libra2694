...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Logika+membimbing+langkah+imajinasi+menembus+batas.;Programs+must+be+written+for+people+to+read.;To+seek+is+to+find+to+build+is+to+live.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Kebenaran+kode+berada+pada+baris+eksekusi.;Mulailah+dari+mana+kamu+berada+gunakan+apa+yang+kamu+punya." alt="Typing SVG" />
  </a>
