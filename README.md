...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Mimpi+tanpa+aksi+hanyalah+ilusi.;Programs+must+be+written+for+people+to+read.;Errors+are+proof+that+you+are+trying.;Be+a+voice+not+an+echo.;Keberhasilan+dimulai+dari+keputusan+untuk+mencoba.;The+best+way+to+predict+the+future+is+to+invent+it.;Detail+kecil+menciptakan+kesempurnaan." alt="Typing SVG" />
  </a>
