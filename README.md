...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Setiap+langkah+adalah+bagian+dari+cerita.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Hustle+in+silence+let+success+make+the+noise.;Not+all+those+who+wander+are+lost.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere." alt="Typing SVG" />
  </a>
