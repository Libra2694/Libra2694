...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Time+is+a+river+of+passing+events.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Keberhasilan+dimulai+dari+keputusan+untuk+mencoba.;To+seek+is+to+find+to+build+is+to+live.;Lost+time+is+never+found+again.;Fokus+pada+proses+hasil+takkan+mengkhianati." alt="Typing SVG" />
  </a>
