...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Lost+time+is+never+found+again.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari.;Sebuah+kode+sejuta+cerita.;Dalam+hening+kita+merajut+mimpi.;What+we+think+we+become.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Programs+must+be+written+for+people+to+read." alt="Typing SVG" />
  </a>
