...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Simplicity+is+key+to+beautiful+code.;Errors+are+proof+that+you+are+trying.;Code+is+poetry+written+in+logic.;Every+moment+is+a+fresh+beginning.;To+seek+is+to+find+to+build+is+to+live.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Lost+time+is+never+found+again." alt="Typing SVG" />
  </a>
