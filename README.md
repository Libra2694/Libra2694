...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Menulis+kode+membelah+sunyinya+malam.;Fokus+pada+proses+hasil+takkan+mengkhianati.;Time+is+a+river+of+passing+events.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Mulailah+dari+mana+kamu+berada+gunakan+apa+yang+kamu+punya.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Programs+must+be+written+for+people+to+read." alt="Typing SVG" />
  </a>
