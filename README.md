...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Dalam+hening+kita+merajut+mimpi.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Code+is+poetry+written+in+logic.;Simplicity+is+key+to+beautiful+code.;The+best+way+to+predict+the+future+is+to+invent+it.;Lost+time+is+never+found+again.;Jangan+biarkan+hari+kemarin+menyita+hari+ini." alt="Typing SVG" />
  </a>
