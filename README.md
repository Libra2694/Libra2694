...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Sebuah+kode+sejuta+cerita.;Terang+akan+datang+setelah+gulita.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Not+all+those+who+wander+are+lost.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Strive+not+to+be+a+success+but+rather+to+be+of+value." alt="Typing SVG" />
  </a>
