...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Every+moment+is+a+fresh+beginning.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Not+all+those+who+wander+are+lost.;What+we+think+we+become.;The+best+way+to+predict+the+future+is+to+invent+it." alt="Typing SVG" />
  </a>
