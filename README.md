...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Be+a+voice+not+an+echo.;Silence+is+the+canvas+of+deep+thoughts.;Make+it+simple+but+significant.;Sunyi+malam+adalah+teman+terbaik+sang+pemikir.;Fokus+pada+proses+hasil+takkan+mengkhianati.;In+the+middle+of+difficulty+lies+opportunity.;Rintangan+adalah+jembatan+menuju+kekuatan." alt="Typing SVG" />
  </a>
