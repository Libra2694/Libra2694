...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Karya+terbaik+lahir+dari+ketekunan+tiada+henti.;Sunyi+malam+adalah+teman+terbaik+sang+pemikir.;The+best+way+to+predict+the+future+is+to+invent+it.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari.;In+the+middle+of+difficulty+lies+opportunity.;Talk+is+cheap.+Show+me+the+code.;Errors+are+proof+that+you+are+trying." alt="Typing SVG" />
  </a>
