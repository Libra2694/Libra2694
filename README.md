...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=The+best+way+to+predict+the+future+is+to+invent+it.;Not+all+those+who+wander+are+lost.;To+seek+is+to+find+to+build+is+to+live.;Talk+is+cheap.+Show+me+the+code.;In+the+middle+of+difficulty+lies+opportunity.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Setiap+langkah+adalah+bagian+dari+cerita." alt="Typing SVG" />
  </a>
