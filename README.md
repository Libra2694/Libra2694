...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Simplicity+is+key+to+beautiful+code.;The+best+way+to+predict+the+future+is+to+invent+it.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Errors+are+proof+that+you+are+trying.;Keberhasilan+dimulai+dari+keputusan+untuk+mencoba.;Fokus+pada+proses+hasil+takkan+mengkhianati.;Lost+time+is+never+found+again." alt="Typing SVG" />
  </a>
