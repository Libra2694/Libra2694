...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Menulis+kode+membelah+sunyinya+malam.;The+best+way+to+predict+the+future+is+to+invent+it.;Setiap+langkah+adalah+bagian+dari+cerita.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Dalam+hening+kita+merajut+mimpi.;Every+moment+is+a+fresh+beginning.;Menanti+fajar+di+batas+cakrawala." alt="Typing SVG" />
  </a>
