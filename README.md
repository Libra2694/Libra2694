...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Hustle+in+silence+let+success+make+the+noise.;Create+your+own+sunshine+on+cloudy+days.;Detail+kecil+menciptakan+kesempurnaan.;Programs+must+be+written+for+people+to+read.;Jangan+biarkan+hari+kemarin+menyita+hari+ini.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Dalam+hening+kita+merajut+mimpi." alt="Typing SVG" />
  </a>
