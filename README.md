...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Not+all+those+who+wander+are+lost.;Menulis+kode+membelah+sunyinya+malam.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Silence+is+the+canvas+of+deep+thoughts.;Simplicity+is+key+to+beautiful+code.;Menanti+fajar+di+batas+cakrawala.;Strive+not+to+be+a+success+but+rather+to+be+of+value." alt="Typing SVG" />
  </a>
