...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Lost+time+is+never+found+again.;Code+is+poetry+written+in+logic.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Dream+without+fear+code+without+limits.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Setiap+langkah+adalah+bagian+dari+cerita.;To+seek+is+to+find+to+build+is+to+live." alt="Typing SVG" />
  </a>
