...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Simplicity+is+the+ultimate+sophistication.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Dream+without+fear+code+without+limits.;The+best+way+to+predict+the+future+is+to+invent+it.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Terang+akan+datang+setelah+gulita.;Silence+is+the+canvas+of+deep+thoughts." alt="Typing SVG" />
  </a>
