...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Programs+must+be+written+for+people+to+read.;To+seek+is+to+find+to+build+is+to+live.;Lost+time+is+never+found+again.;Keberhasilan+dimulai+dari+keputusan+untuk+mencoba.;Jangan+biarkan+hari+kemarin+menyita+hari+ini.;Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari." alt="Typing SVG" />
  </a>
