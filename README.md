...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;To+seek+is+to+find+to+build+is+to+live.;Code+never+lies+comments+sometimes+do.;Lost+time+is+never+found+again.;Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Kebenaran+kode+berada+pada+baris+eksekusi.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere." alt="Typing SVG" />
  </a>
