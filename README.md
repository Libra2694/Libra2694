...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Mulailah+dari+mana+kamu+berada+gunakan+apa+yang+kamu+punya.;Talk+is+cheap.+Show+me+the+code.;Dream+without+fear+code+without+limits.;Detail+kecil+menciptakan+kesempurnaan.;Make+it+simple+but+significant." alt="Typing SVG" />
  </a>
