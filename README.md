...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Silence+is+the+canvas+of+deep+thoughts.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Simplicity+is+key+to+beautiful+code.;The+best+way+to+predict+the+future+is+to+invent+it.;Hustle+in+silence+let+success+make+the+noise.;To+seek+is+to+find+to+build+is+to+live.;Menanti+fajar+di+batas+cakrawala." alt="Typing SVG" />
  </a>
