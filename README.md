...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=The+best+way+to+predict+the+future+is+to+invent+it.;Silence+is+the+canvas+of+deep+thoughts.;Programs+must+be+written+for+people+to+read.;In+the+middle+of+difficulty+lies+opportunity.;Setiap+akhir+adalah+awal+yang+baru.;Every+moment+is+a+fresh+beginning.;Menanti+fajar+di+batas+cakrawala." alt="Typing SVG" />
  </a>
