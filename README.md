...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;Dream+without+fear+code+without+limits.;Terang+akan+datang+setelah+gulita.;Simplicity+is+key+to+beautiful+code.;Setiap+langkah+adalah+bagian+dari+cerita.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;In+the+middle+of+difficulty+lies+opportunity." alt="Typing SVG" />
  </a>
