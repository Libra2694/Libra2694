...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Detail+kecil+menciptakan+kesempurnaan.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Fokus+pada+proses+hasil+takkan+mengkhianati.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Dalam+baris+kode+terdapat+bait-bait+harapan.;Silence+is+the+canvas+of+deep+thoughts.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari." alt="Typing SVG" />
  </a>
