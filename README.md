...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Detail+kecil+menciptakan+kesempurnaan.;Lost+time+is+never+found+again.;Menulis+kode+membelah+sunyinya+malam.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Code+is+poetry+written+in+logic.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;To+seek+is+to+find+to+build+is+to+live." alt="Typing SVG" />
  </a>
