...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=What+we+think+we+become.;Silence+is+the+canvas+of+deep+thoughts.;Simplicity+is+key+to+beautiful+code.;The+best+way+to+predict+the+future+is+to+invent+it.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Fokus+pada+proses+hasil+takkan+mengkhianati.;Setiap+akhir+adalah+awal+yang+baru." alt="Typing SVG" />
  </a>
