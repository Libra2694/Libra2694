...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Sebuah+kode+sejuta+cerita.;Dream+without+fear+code+without+limits.;Menanti+fajar+di+batas+cakrawala.;Rintangan+adalah+jembatan+menuju+kekuatan.;Terang+akan+datang+setelah+gulita.;Silence+is+the+canvas+of+deep+thoughts.;To+seek+is+to+find+to+build+is+to+live." alt="Typing SVG" />
  </a>
