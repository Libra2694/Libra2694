...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Mimpi+tanpa+aksi+hanyalah+ilusi.;Make+it+simple+but+significant.;Hustle+in+silence+let+success+make+the+noise.;Every+moment+is+a+fresh+beginning.;Sunyi+malam+adalah+teman+terbaik+sang+pemikir.;To+seek+is+to+find+to+build+is+to+live.;The+best+way+to+predict+the+future+is+to+invent+it." alt="Typing SVG" />
  </a>
