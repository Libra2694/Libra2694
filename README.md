...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Dream+without+fear+code+without+limits.;Jangan+biarkan+hari+kemarin+menyita+hari+ini.;Terang+akan+datang+setelah+gulita.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Fokus+pada+proses+hasil+takkan+mengkhianati.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;Lost+time+is+never+found+again." alt="Typing SVG" />
  </a>
