...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Hidup+adalah+seni+menggambar+tanpa+penghapus.;To+seek+is+to+find+to+build+is+to+live.;Be+a+voice+not+an+echo.;Menanti+fajar+di+batas+cakrawala.;Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Setiap+langkah+adalah+bagian+dari+cerita.;Every+moment+is+a+fresh+beginning." alt="Typing SVG" />
  </a>
