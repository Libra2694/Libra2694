...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Simplicity+is+key+to+beautiful+code.;To+seek+is+to+find+to+build+is+to+live.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Silence+is+the+canvas+of+deep+thoughts.;Time+is+a+river+of+passing+events.;Lost+time+is+never+found+again.;Dream+without+fear+code+without+limits." alt="Typing SVG" />
  </a>
