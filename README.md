...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;Be+a+voice+not+an+echo.;Sunyi+malam+adalah+teman+terbaik+sang+pemikir.;Create+your+own+sunshine+on+cloudy+days.;Silence+is+the+canvas+of+deep+thoughts.;Karya+terbaik+lahir+dari+ketekunan+tiada+henti.;Hustle+in+silence+let+success+make+the+noise." alt="Typing SVG" />
  </a>
