...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Not+all+those+who+wander+are+lost.;Hustle+in+silence+let+success+make+the+noise.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Logika+membimbing+langkah+imajinasi+menembus+batas.;In+the+middle+of+difficulty+lies+opportunity.;Programs+must+be+written+for+people+to+read." alt="Typing SVG" />
  </a>
