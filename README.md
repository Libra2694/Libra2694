...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Logika+membimbing+langkah+imajinasi+menembus+batas.;Waktu+terus+berjalan+tanpa+pernah+menunggu.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Logic+will+get+you+from+A+to+B+imagination+will+take+you+everywhere.;Simplicity+is+key+to+beautiful+code.;Keberhasilan+dimulai+dari+keputusan+untuk+mencoba.;Setiap+langkah+adalah+bagian+dari+cerita." alt="Typing SVG" />
  </a>
