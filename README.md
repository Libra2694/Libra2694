...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=What+we+think+we+become.;Silence+is+the+canvas+of+deep+thoughts.;Secangkir+kopi+sebaris+kode+sejuta+mimpi.;Dalam+hening+kita+merajut+mimpi.;Kebenaran+kode+berada+pada+baris+eksekusi.;Strive+not+to+be+a+success+but+rather+to+be+of+value.;To+seek+is+to+find+to+build+is+to+live." alt="Typing SVG" />
  </a>
