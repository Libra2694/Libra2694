...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Terang+akan+datang+setelah+gulita.;Not+all+those+who+wander+are+lost.;Time+is+a+river+of+passing+events.;To+seek+is+to+find+to+build+is+to+live.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari.;Logika+membimbing+langkah+imajinasi+menembus+batas." alt="Typing SVG" />
  </a>
