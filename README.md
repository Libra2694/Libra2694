...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=To+seek+is+to+find+to+build+is+to+live.;Dream+without+fear+code+without+limits.;Code+is+poetry+written+in+logic.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Setiap+akhir+adalah+awal+yang+baru.;Mimpi+tanpa+aksi+hanyalah+ilusi.;Karya+terbaik+lahir+dari+ketekunan+tiada+henti." alt="Typing SVG" />
  </a>
