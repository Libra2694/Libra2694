...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Code+is+poetry+written+in+logic.;Menulis+kode+membelah+sunyinya+malam.;Sebuah+kode+sejuta+cerita.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Rintangan+adalah+jembatan+menuju+kekuatan.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;Dream+without+fear+code+without+limits." alt="Typing SVG" />
  </a>
