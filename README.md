...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Mimpi+tanpa+aksi+hanyalah+ilusi.;Dalam+hening+kita+merajut+mimpi.;Simplicity+is+key+to+beautiful+code.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Code+is+poetry+written+in+logic.;Create+your+own+sunshine+on+cloudy+days.;The+best+way+to+predict+the+future+is+to+invent+it." alt="Typing SVG" />
  </a>
