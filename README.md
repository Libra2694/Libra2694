...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Menulis+kode+membelah+sunyinya+malam.;Hustle+in+silence+let+success+make+the+noise.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Talk+is+cheap.+Show+me+the+code.;Not+all+those+who+wander+are+lost.;Every+moment+is+a+fresh+beginning.;Dalam+baris+kode+terdapat+bait-bait+harapan." alt="Typing SVG" />
  </a>
