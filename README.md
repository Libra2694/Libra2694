...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Before+software+can+be+reusable+it+first+has+to+be+usable.;Lost+time+is+never+found+again.;In+the+middle+of+difficulty+lies+opportunity.;Menanti+fajar+di+batas+cakrawala.;Jangan+biarkan+hari+kemarin+menyita+hari+ini.;Hidup+adalah+seni+menggambar+tanpa+penghapus.;To+seek+is+to+find+to+build+is+to+live." alt="Typing SVG" />
  </a>
