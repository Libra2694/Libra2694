...
<!-- STARTS_HERE_TYPING_SVG -->
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Outfit&weight=600&size=22&duration=3500&pause=1000&color=A855F7&center=true&vCenter=true&width=600&lines=Dalam+baris+kode+terdapat+bait-bait+harapan.;Be+a+voice+not+an+echo.;Mimpi+tanpa+aksi+hanyalah+ilusi.;Not+all+those+who+wander+are+lost.;Before+software+can+be+reusable+it+first+has+to+be+usable.;Logika+membimbing+langkah+imajinasi+menembus+batas.;Satu+langkah+kecil+hari+ini+adalah+awal+lompatan+besar+esok+hari." alt="Typing SVG" />
  </a>
